...
const PokemonCard = ({id, name, img, type, values, isActive, minimize, className, onClickCardTurn, isSelected, possession}) => {
    const handleOnClick = () => {
        onClickCardTurn && onClickCardTurn(id, !isActive);
    };
